...
class Settings:
    ...
    model_timeout_ms: int = int(os.getenv("JARVIS_MODEL_TIMEOUT_MS", "20000"))
    ...
    stt_model: str = os.getenv("JARVIS_STT_MODEL", "tiny.en")
    vad_silence_limit: float = float(os.getenv("JARVIS_VAD_SILENCE_LIMIT", "1.0"))
    vad_no_speech_timeout: float = float(os.getenv("JARVIS_VAD_NO_SPEECH_TIMEOUT", "2.0"))
